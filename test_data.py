...
class TestData:
    ...
    data_set_to_make_order_1 = [
        "Иван", "Иванов", "ул. Садовая, д.22 кв.100", "Преображенская площадь", "81234567890", "сутки", "черный"
    ]

    data_set_to_make_order_2 = [
        "Любовь", "Козлова", "ул. Лесная, д.777 кв.5", "Лихоборы", "+71234567890", "двое суток", "серый"
    ]
